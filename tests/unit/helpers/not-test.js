...
module('helper:not', function(hooks) {
  ...
  test('simple test 1', async function(assert) {
    ...
    assert.equal(this.element.textContent, '[false] [true] [true] [true] [true] [false]', 'value should be "[false] [true] [true] [true] [true] [false]"');
  });
  ...
  test('simple test 2', async function(assert) {
    ...
    assert.equal(this.element.textContent, '[false] [false] [true] [false]', 'value should be "[false] [false] [true] [false]"');
  });
});
